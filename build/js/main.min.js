...
var _subscriptionTabs = require("./subscription-tabs");
var _swiperNaviEvents = require("./swiper-navi-events");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _smoothScroll.setSmoothScroll)();
  (0, _subscriptionTabs.selectSubscription)();
  (0, _subscriptionTabs.hoverSubscriptionOption)();
  (0, _swiperNaviEvents.setEventsNextButtons)();
  (0, _swiperNaviEvents.setEventsPrevButtons)();
  // setPlayEvent();
  // onPlayerReady();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./smooth-scroll":11,"./subscription-tabs":12,"./swiper-navi-events":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
exports.setSmoothScroll = setSmoothScroll;
// Плавный Scroll к smooth-якорям (в разметке их имена начинаются со "#smooth-")

function setSmoothScroll() {
  document.querySelectorAll('a[href^="#smooth-"]').forEach(function (anchor) {
...
exports.hoverSubscriptionOption = hoverSubscriptionOption;
exports.selectSubscription = selectSubscription;
//
var subscriptions = document.querySelector('[data-subscription="taplist"]');
var pricelists = document.querySelector('[data-subscription="pricelist"]');
function clearActiveSubscription() {
  var activeSubscription = subscriptions.querySelector('.is-active');
  var activePricelist = pricelists.querySelector('.is-open');
...
function selectSubscription() {
  subscriptions.addEventListener('click', function (evt) {
    ...
    if (evt.target.classList.contains('subscription__time')) {
      ...
      var data = '[data-time='.concat(evt.target.getAttribute('data-time'), ']');
...
exports.setEventsNextButtons = setEventsNextButtons;
exports.setEventsPrevButtons = setEventsPrevButtons;
//
